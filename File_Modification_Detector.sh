...
cat << EOF
Usage: 
  md5hashcheck [OPTION...] [FILE...] - MD5Hash Checker
...
Examples:
  md5hashcheck /home/user/test		Creates md5checksums of each content in /home/user/test folder to current working directory.
  md5hashcheck			Create md5checksums of each content current directory in current directory.
